...
export const getFactoryTimeSpan = (factoryid, startdate, enddate, signal) => {
  return http.get("/report/json?jid=290&factoryid="+factoryid+"&startdate="+startdate+"&enddate="+enddate, { signal });
}

export const getFactoryProduction = (factoryid, startdate, enddate, signal) => {
  return http.get("/report/json?jid=291&factoryid="+factoryid+"&startdate="+startdate+"&enddate="+enddate, { signal });
}
