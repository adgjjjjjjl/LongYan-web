...
export const columnsMapping = {
  ...
  "叶复烤":["cntrno","outno","f_cntr_no_cyg","f_formula2","caseno","casenonum1","caseno_sp1","casenonum_sp1","caseno_sp2","casenonum_sp2","caseno_cg","casenonum_cg","f_weight","f_mode","yujishichang","yujitime","newyisumvalue","sumvalue"],
